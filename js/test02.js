function get_parm_w(gt, challenge, distance, s, c, trace) {
    var window = global;
    var ht = {};
            ...
            switch ($_DBBCG) {
                ...
                function o(t) {
                    ...
                    for (s = function m(t) {
                        ...
                        $_HJIM.shift();
                        var $_IABL = $_HJIM[0];
                        var e, n = t[$_IAAB(192)], r = n + 8, i = 16 * (1 + (r - r % 64) / 64), o = Array(i - 1), s = 0,
                            a = 0;
                        while (a < n)
                            s = a % 4 * 8,
    ...
    var U = function () {
        ...
        return m[$_IAJA(236)][$_IBAP(342)] = function O(t) {
            ...
            y[$_IAJA(236)][$_IBAP(305)] = function G(t, e) {
                ...
                $_JDDo.shift();
                var $_JDGj = $_JDDo[0];
                var n, r = t % this[$_JDE_(349)], i = this[$_JDFL(349)] - r, o = (1 << i) - 1,
                    s = Math[$_JDFL(219)](t / this[$_JDE_(349)]), a = this[$_JDE_(345)] << r & this[$_JDFL(379)];
            ...
            y[$_IBAP(236)][$_IBAP(213)] = function $_GM(t) {
                ...
                var n, r = (1 << e) - 1, i = !1, o = $_JHJu(2), s = this[$_JIAb(376)],
    ...
    // function get_parmu() {
    //     return new U()['encrypt'](randomStr());
    // };
    // console.log(parm_u)
    u = new U()['encrypt'](randomStr());
    i = {
        'gt': gt,
        "challenge": challenge
    };
    passtime = trace[trace.length - 1][trace[trace.length - 1].length - 1]
    let pram_o_rp = X(i['gt'] + i['challenge']['slice'](0, 32) + passtime);

    // t 是滑块距离
    t = distance;
    let pram_o_userresponse = H(t, i['challenge']);
    // c s 是接口返回值

    // s = s;
    // c = [12, 58, 98, 36, 43, 95, 62, 15, 12];
    // tract = [[-44, -22, 0],[0, 0, 0],[0, -1, 11],[0, -2, 27],[0, -3, 28],[1, -3, 31],[2, -3, 33],[3, -3, 36],[4, -3, 41],[4, -4, 42],[6, -4, 45],[7, -4, 47],[8, -4, 48],[9, -4, 51],[11, -4, 53],[13, -5, 54],[14, -5, 56],[17, -5, 59],[19, -6, 60],[22, -6, 62],[24, -7, 64], [27, -7, 67],[29, -7, 68],[32, -7, 70],[35, -7, 73], [38, -7, 74],[41, -8, 76],[44, -8, 78],[47, -8, 81],[51, -9, 82],[54, -9, 84],[58, -9, 87],[61, -10, 88],[64, -10, 90],[69, -11, 92],[73, -11, 94],[79, -11, 96],[83, -11, 98], [89, -11, 101],[93, -12, 103], [99, -13, 104],[103, -13, 106],[109, -13, 108], [115, -14, 110], [120, -14, 112],[126, -15, 115],[133, -16, 116],[138, -16, 118], [145, -17, 120],[151, -18, 123], [158, -18, 124],[164, -19, 126], [171, -20, 129],[177, -21, 130], [184, -21, 132],[189, -22, 135], [196, -22, 136], [202, -24, 138],[202, -24, 139]];
    pram_o_a = W['prototype']["\u0024\u005f\u0046\u0044\u005f"](trace);

    console.log(pram_o_a);
    pram_o_aa = W['prototype']["\u0024\u005f\u0042\u0042\u0045\u0044"](pram_o_a, c, s);
    o = {
        "aa": pram_o_aa,
        "ep": {v: '7.9.2', $_BIE: false, me: true, td: -1},
        "h9s9": "1816378497",
        "imgload": distance,
        "lang": "zh-cn",
        "passtime": passtime,
        "rp": pram_o_rp,
        "userresponse": pram_o_userresponse,

    };
    // console.log(U)


    pram_l = V['encrypt'](JSON.stringify(o), randomStr());
...
console.log(get_parm_w("019924a82c70bb123aae90d483087f94", "000f9708b60f42678d3606c039d0b65633", 28, "345a2941", [12, 58, 98, 36, 43, 95, 62, 15, 12], [
    [
        -28,
        -32,
        0
