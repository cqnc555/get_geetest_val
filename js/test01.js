function get_parm_w(gt_value,challage_value,c,s,distance,passtime,trace) {
...
// 生成参数U
    ...
    u = e = new U()['encrypt'](rt)
// u = e = new U()[$_CBFJN(392)](rt())
// 用新的34位的challage  每次都会变
    userresponse = H(distance, challage_value)

// console.log("userresponse---" + userresponse);

// o = {
//     "lang": "zh-cn",
//     "userresponse": "999c9c9c7ce88",
//     "passtime": 323,
//     "imgload": 69,
//     "aa": "S(!!DxxsxsxlxsssxsssxssssImsss(!!((./*3*-/*1*/0/,-3A5A$j**5Y",
//     "ep": {
//         "v": "7.9.2",
//         "$_BIE": false,
//         "me": true,
...
// }
    ...
    pram_o_aa = W['prototype']["\u0024\u005f\u0042\u0042\u0045\u0044"](W['prototype']["\u0024\u005f\u0046\u0044\u005f"](trace), c, s);
    pram_o_rp = X(gt_value + challage_value['slice'](0, 32) + passtime);
    ...
    pram_l = V['encrypt'](JSON.stringify(o), rt);
    h = m['$_FEX'](pram_l)
    return h + u
}
